...
type OperationHandlerFunc func(header, request interface{}, w http.ResponseWriter, httpRequest *http.Request) (response interface{}, err error)
...
type dummyHeader interface{}

type operationHandler struct {
	requestFactory RequestFactoryFunc
	headerFactory  RequestFactoryFunc
...
func (s *Server) RegisterHandler(path string, action string, messageType string, headerFactory, requestFactory RequestFactoryFunc, operationHandlerFunc OperationHandlerFunc) {
...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case "POST":
		...
		response, err := actionHandler.handler(header, request, w, r)
		if err != nil {
